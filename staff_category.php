...
class category extends database
{
    public function catFunction()
    {
        if (isset($_POST['submit'])) {
            ...
            header('location:staff_pdf.php?title=' . $file);
        }
        # code...
    }
}
                ...
                <div class="bg_color">
                    ...
                    <div class="row text-center mt-5">
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=TAMAN SEMULA" style="text-decoration: none;">
                        ...
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=PENGEMBANGAN" style="text-decoration: none;">
                                <div class="p-5 bg-white dis">
                                    <i class="fas fa-leaf fa-5x" style="color: #296e01"></i>
                                    <h3 class="font-weight-bold text-center mt-3"
                        ...
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=USAHAWAN" style="text-decoration: none;">
                                <div class="p-5 bg-white dis">
                                    <i class="fas fa-leaf fa-5x" style="color: #296e01"></i>
                                    <h3 class="font-weight-bold text-center mt-3"
                        ...
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=PRODUKTIVITI & PEMASARAN"
                        ...
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=PENTADBIRAN" style="text-decoration: none;">
                                <div class="p-5 bg-white dis">
                                    <i class="fas fa-leaf fa-5x" style="color: #296e01"></i>
                                    <h3 class="font-weight-bold text-center mt-3"
                                        style="color: #05445E; font-family: 'Lato', sans-serif;">PENTADBIRAN</h3>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=KEWANGAN" style="text-decoration: none;">
                                <div class="p-5 bg-white dis">
                                    <i class="fas fa-leaf fa-5x" style="color: #296e01"></i>
                                    <h3 class="font-weight-bold text-center mt-3"
                                        style="color: #05445E; font-family: 'Lato', sans-serif;">KEWANGAN</h3>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-6 col-12 mt-4">
                            <a href="staff_pdf_default.php?category=LAIN-LAIN" style="text-decoration: none;">
                                <div class="p-5 bg-white dis">
                                    <i class="fas fa-leaf fa-5x" style="color: #296e01"></i>
                                    <h3 class="font-weight-bold text-center mt-3"
                                        style="color: #05445E; font-family: 'Lato', sans-serif;">LAIN-LAIN</h3>
                                </div>
                            </a>
                        </div>
